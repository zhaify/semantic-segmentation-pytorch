...
if __name__ == '__main__':
    ...
    cfg.merge_from_file('config/ade20k-resnet101-upernet.yaml')
    cfg.merge_from_list(args.opts)
    # cfg.freeze()

    logger = setup_logger(distributed_rank=0)   # TODO
    logger.info("Loaded configuration file {}".format('config/ade20k-resnet101-upernet.yaml'))
